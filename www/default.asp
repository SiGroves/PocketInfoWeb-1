...
<html>
   <head>
	  ...
	  <link rel="stylesheet" href="themes/tiwPocketBlue.min.css" id="theme"/>
	  <link rel="stylesheet" href="themes/jquery.mobile.icons.min.css" />
	 
	  <script src="https://ajax.googleapis.com/ajax/libs/jquerymobile/1.4.5/jquery.mobile.min.js"></script>

	  <script type="text/javascript" src="libraries/underscore-min.js"></script>
	  <script  type="text/javascript" src="libraries/progressBar/ngprogress.js"></script>
	  <script  type="text/javascript" src="libraries/moment.min.js"></script>
	  
      <script type="text/javascript" src="remoteIssues.js"></script>
      <script type="text/javascript" src="libraries/angularOnlineCheck.js"></script>	
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
	  ...
	  <link rel="stylesheet" href="libraries/progressBar/ngProgress.css">
...
<body  ng-app="myApp" ng-controller="IssuesController">
	...
	<div data-role="page" data-title="Pocket Infoweb" class="jqm-demos" id="Info">
	    ...
	    <div role="main" class="ui-content jqm-content jqm-fullwidth">			
			<img src="content/workShopEquipmentLogo.png" style="width:100%;"/>
			<img src="content/tiwHeader.png" style="width:100%;"/>
			<div class="row">
         		<div class="col-md-12">
...
<div id="wipBuilder" data-title="Tools Locator" data-role="page">
	    ...
	    <div role="main" class="ui-content jqm-content jqm-fullwidth">
			<div class="row">
				...
				<div class="col-md-12">
					<p ng-show="{{whileLoading}}"">PLEASE WAIT - LOADING TOOLS LIST <img height="24px" src="../content/images/icons/working.gif"/></p>
